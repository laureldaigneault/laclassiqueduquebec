<?php
	...
	class ConsoleImagesAction extends CommonAction {
		...
		protected function executeAction() {
			...
			if(isset($_POST["submit_image"]) && isset($_POST["nameOfFile"]) && isset($_POST["languageFile"])) {
				...
				if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "ico") {
					$this->imageUploadError = "Sorry, only jpg, jpeg, ico & png files are allowed.";
					$uploadOk = 0;
				}
				...
				// if everything is ok, try to upload file
					...
					$image_error = ImagesDAO::uploadImage($target_file, $_POST['nameOfFile'], $_POST['languageFile'], 0);
			...
			$this->images = ImagesDAO::getImages(0); //not logos
