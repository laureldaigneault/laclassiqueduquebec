<?php 
	...
	require('action/ConsoleImagesAction.php');

	$action = new ConsoleImagesAction();
	$action->execute();
...
?>
	...
	<div class="col-md-8 col-md-offset-2">
		<div class="row console-container">
			...
			<h1 class="console-container-title">Télécharger une nouvelle image</h1>


			<form action="console_images.php" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-4">
						<input type="file" name="fileToUpload" id="fileToUpload">
					</div>
					<div class="col-md-4">
						<input type="text" placeholder="nom de l'image" style="width: 100%" name="nameOfFile" id="nameOfFile">
					</div>
					<div class="col-md-4">
		...
		<p style="margin-left: 10px; margin-top: 40px; font-style: italic;">Liste de toutes les images:</p>
		<div class="row console-container">
			<?php
	...
	<div class="made-modal" id="myModal">
		<form action="console_images.php" method="post" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="col-md-6">
					<input type="text" placeholder="nom de l'image'" style="width: 100%" name="nameOfFileUpdate" id="nameOfFileUpdate">
				</div>
...
<script>
		...
		function deleteImage(id, url, name){
			if(confirm("Êtes-vous certain de vouloir supprimer l'image: "+name+"? Cette action pourrait corrompre les emplacement du site qui utilisent cette image. Il est recommandé de 'Modifier' l'image au lieu de la supprimer.")){
				$.ajax({
					url: 'dummy.php',
					type: 'post',
					data: {
					...
					success: function(data, status) {
						if(data == "ok") {
							window.location.replace("console_images.php");
						} else {
