...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Classique console</a>
    </div>
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      ...
      <ul class="nav navbar-nav">
        <li><a href="console_home.php">Accueil</a></li>
				...
				<li><a href="console_babillard.php">Babillard</a></li>
				<li><a href="console_competitors.php">Compétiteurs</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="console_logos.php">Logos</a></li>
				<li><a href="console_images.php">Images</a></li>
        <li><a href="console_videos.php">Vidéos</a></li>
